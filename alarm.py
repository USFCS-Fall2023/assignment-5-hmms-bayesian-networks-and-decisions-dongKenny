...
def alarm_queries():
    ...
    q_1 = alarm_infer.query(variables=["MaryCalls"], evidence={"JohnCalls": "yes"})
    q_2 = alarm_infer.query(variables=["JohnCalls", "MaryCalls"], evidence={"Alarm": "yes"})
    q_3 = alarm_infer.query(variables=["Alarm"], evidence={"MaryCalls": "yes"})
